...
| Task touches CLI command behavior or installer distribution | Read `docs/decisions/0005-prebuilt-rust-harness-cli.md`, `scripts/README.md`, CLI help output from `scripts/bin/harness-cli help`, and installer docs if present in the current repository. |
